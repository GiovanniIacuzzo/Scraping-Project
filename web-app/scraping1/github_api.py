...
# =========================
def get_candidate_users_advanced(
    target_count,
    my_city=None,
    nearby_cities=None,
    keywords_bio=None,
    keywords_readme=None,
    locations=None,
    language="Python",
    ...
    primary_cities = [c.strip() for c in ([my_city] + (nearby_cities or [])) if c.strip()]
    ...
    while len(valid_users) < target_count:
        cities_to_search = primary_cities or ["Italy"]
        ...
        if len(valid_users) < target_count and locations:
